...
def external_plugin_deps():
  ...
  maven_jar(
    name = 'gitblit_jar',
    artifact = 'com.gitblit:gitblit:1.7.1',
    repository = 'http://gitblit.github.io/gitblit-maven/',
  )
  ...
  maven_jar(
    name = 'lucene_core',
    artifact = 'org.apache.lucene:lucene-core:4.10.2',
    sha1 = 'c01e3d675d277e0a93e7890d03cc3246b2cdecaa',
  )

  maven_jar(
    name = 'lucene_highlighter',
    artifact = 'org.apache.lucene:lucene-highlighter:4.10.2',
    sha1 = '7ced704190e1e5b9a9b32edec6dba9116d69ae72',
  )

  maven_jar(
    name = 'lucene_memory',
    artifact = 'org.apache.lucene:lucene-memory:4.10.2',
